...
type Banner = { id: string; title: string; img: string; alt: string; description?: string }
...
export default function HomePage() {
  ...
  const banners: Banner[] = [
    { id: "b1", title: "Discover Amazing Events", img: "/Banner.svg", alt: "Event banner", description: "Find the best events, movies, and sports activities near you" },
    { id: "b2", title: "New Experiences Await", img: "/Banner.svg", alt: "Fresh events banner", description: "Join exciting events and create memorable moments" },
  ]
    ...
    <div className={`min-h-dvh bg-gray-50 ${inter.className}`}>
      ...
      <div className="mx-auto w-full max-w-sm sm:max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-6xl bg-white">
        ...
        <main className="px-4 sm:px-6 md:px-8 pb-[96px] md:pb-24 md:pt-36">
          {/* Banner carousel */}
          <section aria-label="Promotions" className="mb-6 md:mb-8">
            <div
            ...
            >
              <div
                ref={sliderRef}
                className="flex"
                style={{ width: `${banners.length * 50}%`, transform: `translateX(-${index * 100}%)` }}
              >
                {banners.map((b) => (
          ...
          {eventsLoading ? (
            <div className="mb-6 md:mb-8">
              <h2 className="mb-3 md:mb-4 text-lg md:text-xl font-semibold text-zinc-900">All Events</h2>
