...
import { campusData, getCampusById } from "@/lib/campuses";
        ...
        <main className="px-4 pb-[96px]">
          ...
          <section aria-labelledby="all-events" className="mb-6">
            <div className="mb-3 flex items-center gap-3">
              ...
              <button className="text-sm font-medium text-sky-600" aria-label="See all events"><img src="/seeall.svg"></img></button>
            </div>
            <div className="grid grid-cols-2 gap-3">
              {events
                ...
                .map((event) => {
                  ...
                  return (
                    <Link key={event.id} href={`/movies/Eventname/${slug}`} className="block">
