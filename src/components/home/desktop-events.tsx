  ...
  return (
    <section className="mb-8">
      ...
      <div className="grid grid-cols-4 gap-6">
        {events.map((event) => (
          <Link key={event.id} href={event.href || '/campus-events/{event.id}'} className="group">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 group-hover:border-sky-200">
              ...
              <div className="p-4">
                ...
                <h3 className="font-semibold text-gray-900 mb-2 group-hover:text-sky-600 transition-colors line-clamp-2">
                  {event.name}
                </h3>
